...
test('G4.3B.5R.2.4.1+ lab preserves Parry separation telemetry after .2.6 balance-break split', () => {
  ...
  assert.match(source, /predictive-intercept-parry\.js\?v=g43b5r26/);
  assert.match(source, /two-actor-combat-integration\.js\?v=g43b5r26/);
  assert.match(source, /shield-driven-contact-coupling\.js\?v=g43b5r26/);
