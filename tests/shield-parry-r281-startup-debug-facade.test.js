...
test('R18M.C5 debug facade preserves the public API shape without owning gameplay execution', () => {
  ...
  const exchangeState = {
    ...
    latestGuardCoverage: 'guard-coverage', latestGuardResidual: 'guard-residual', latestParryWhiff: 'whiff',
  ...
  assert.deepEqual(Object.keys(api), [
    ...
    'latestFinePlan', 'latestFineTracking', 'latestGuardCoverage', 'latestGuardResidual', 'latestParryWhiff',
