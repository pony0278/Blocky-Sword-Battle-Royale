...
} from './two-actor-whole-body-recoil-burst.js?v=g43b5r281-closed-loop-old-b3-r18i5';
...
export function buildParriedReactionDefinition(input = {}) {
  ...
  return Object.freeze({
    ...
    channelPolicy: Object.freeze({
      atImpact: 'contact-pose-held-while-reaction-definition-is-selected',
      atDeflectImpulse: 'canonical-full-body-old-b3-from-elapsed-zero',
      atContactRelease: 'continuity-bridge-then-full-body-old-b3-without-contact-correction',
      contactConstraintRunsBeforeVisibleReaction: true,
